...
class Voyage
{
    ...
    public function getImageUrl(): ?string
    {
        ...
        $value = trim($this->imageUrl);
        if ($value === '') {
            return null;
        }

        // Keep absolute URLs and root-relative paths as they are.
        if (preg_match('#^https?://#i', $value) || str_starts_with($value, '/')) {
            return $value;
        }

        // If only a filename is stored in DB, resolve it to the public images folder.
