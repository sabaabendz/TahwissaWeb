...
class ReservationEvenement
{
    ...
    #[ORM\Column(name: 'montant_total_tnd', type: Types::FLOAT, nullable: true)]
    private ?float $montantTotalTnd = null;

    /** True si les places ont été déduites du stock (nouveau flux paiement / réservation). */
    #[ORM\Column(name: 'seats_held', type: Types::BOOLEAN, options: ['default' => false])]
    private bool $seatsHeld = false;
    ...
    public function getMontantTotalTnd(): ?float
    {
        return $this->montantTotalTnd;
    }

    public function setMontantTotalTnd(?float $montantTotalTnd): static
    {
        $this->montantTotalTnd = $montantTotalTnd;
        return $this;
    }

    public function isSeatsHeld(): bool
    {
        return $this->seatsHeld;
    }

    public function setSeatsHeld(bool $seatsHeld): static
    {
