 ...
 */
class getReservationEvenementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationEvenementRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationEvenementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationEvenementRepository.php';

        return $container->privates['App\\Repository\\ReservationEvenementRepository'] = new \App\Repository\ReservationEvenementRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
