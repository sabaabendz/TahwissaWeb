...
/* agent/evenement/edit.html.twig */
class __TwigTemplate_8d33804e793c697ab3ed8f7c7010bb02 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "agent/evenement/edit.html.twig"));
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Agent - Modifier Événement";
    ...
    <div class=\"top-bar-right\">
        <a href=\"";
        // line 11
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("agent_evenement_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["evenement"]) || array_key_exists("evenement", $context) ? $context["evenement"] : (function () { throw new RuntimeError('Variable "evenement" does not exist.', 11, $this->source); })()), "id", [], "any", false, false, false, 11)]), "html", null, true);
...
";
    ...
    {
        return "agent/evenement/edit.html.twig";
    }
...
{% block title %}Agent - Modifier Événement{% endblock %}
...
<div class=\"top-bar\">
    ...
    <div class=\"top-bar-right\">
        <a href=\"{{ path('agent_evenement_show', {id: evenement.id}) }}\" class=\"btn btn-outline btn-sm\"><i class=\"fas fa-eye\"></i> Voir</a>
...
<div class=\"form-card\">
    ...
    <div class=\"form-actions\">
        <a href=\"{{ path('agent_evenement_index') }}\" class=\"btn btn-outline btn-sm\">Annuler</a>
        <button type=\"submit\" class=\"btn btn-primary btn-sm\"><i class=\"fas fa-save\"></i> Enregistrer</button>
    </div>
...
{% endblock %}
", "agent/evenement/edit.html.twig", "C:\\Users\\sabso\\Downloads\\chedliweb\\tahwissa-symfony\\templates\\agent\\evenement\\edit.html.twig");
    }
}
